      ...
      <div className="container mx-auto px-4 md:px-6 max-w-screen-xl relative z-10 flex flex-col items-center justify-center">
        ...
        >
          ...
          <div className="space-y-4 max-w-4xl mx-auto">
            ...
            >
              Hi, <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 via-blue-500 to-purple-600">Engineering The Future of Digital Reality</span>
            </motion.h1>
