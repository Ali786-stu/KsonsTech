      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 mb-16">
          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            <p className="text-muted-foreground text-base leading-relaxed max-w-sm">
              We build scalable digital solutions. Let's build something extraordinary together.
            </p>
            <div className="flex gap-4 pt-4">
              <SocialIcon href="https://#" icon={<Github className="h-5 w-5" />} label="GitHub" />
              <SocialIcon href="https://#" icon={<Linkedin className="h-5 w-5" />} label="LinkedIn" />
              <SocialIcon href="https://#" icon={<Twitter className="h-5 w-5" />} label="Twitter" />
              <SocialIcon href="mailto:#" icon={<Mail className="h-5 w-5" />} label="Email" />
            </div>
          </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-sm text-muted-foreground text-center md:text-left">
            © {currentYear} KSONSTech. Built with precision and passion.
          </p>
